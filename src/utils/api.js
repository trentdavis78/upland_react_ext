...
export const subDivide = (eosid,propNFTID) => {
  const url = 'https://7bf4-2003-f8-973e-2100-3893-68b1-83a7-16bc.eu.ngrok.io/upland/structure/divide'
  return new Promise((resolve, reject) => {
    axios
      .post(url, {eosId:eosid,structureId:propNFTID})
      .then((res) => {
...
export const sendStructureToContainer = (containerId,propNFTID, accessToken) => {
  const payload =    {
